# Dots and Boxes 2D Board Game v3.0.0

A modern, feature-rich implementation of the classic Dots and Boxes game with AI opponent, online multiplayer, user authentication, and enhanced gameplay mechanics. Built with HTML5 Canvas, JavaScript, Node.js, Socket.IO, and MongoDB for a complete gaming experience.

## 🎯 Game Modes

### 🎮 Single Player vs AI
- Play against an intelligent AI opponent with strategic gameplay algorithms
- AI automatically handles dice rolling, Lucky Wheel spinning, and line drawing
- **Enhanced AI**: Advanced decision-making with lookahead and strategic planning
- **Lucky Wheel Support**: AI can trigger and use Lucky Wheel effects
- Perfect for solo practice and skill development

### 👥 Two Players (Local)
- Play with a friend on the same device
- Customizable player names for personalized experience
- Real-time turn switching and score tracking
- **Lucky Wheel Enabled**: Full Lucky Wheel functionality with all effects
- **Enhanced UX**: Smooth gameplay with proper turn management

### 🌐 Online Multiplayer
- Create or join lobbies with unique 6-character codes
- Real-time synchronization between players with Socket.IO
- Cross-platform compatibility (Desktop & Mobile)
- **Balanced Gameplay**: Lucky Wheel disabled for fair online competition
...
- **Dynamic Gameplay**: Dice rolls random values 1-6 for strategic gameplay
- **Mode-Specific Behavior**: Rolling a 6 triggers different effects based on game mode
- **Single Player & Two Players**: Lucky Draw wheel with random effects
- **Online Multiplayer**: Lucky Wheel disabled for balanced competition
- **Turn Management**: Lucky Wheel can only be triggered once per turn

### 🎡 Lucky Draw Wheel System
- **Trigger**: Activated when rolling a 6 on the dice (Single Player & Two Players only)
- **Wheel Effects**:
  - 🎯 **Extra Turn**: Get an additional turn immediately
  - 🎲 **Roll Again**: Get an extra dice roll after finishing current lines
  - 💨 **Poof! Turn vanished**: Your turn ends immediately, skip to opponent
  - ⭐ **Bonus Points**: Earn bonus points for completed squares
  - 🔄 **Switch Turns**: Immediately switch to opponent's turn
- **Visual Design**: Beautiful spinning wheel with smooth animations
- **Button Layout**: Spin and Close buttons positioned left and right
- **Balanced Gameplay**: Disabled in Online Multiplayer for fair competition
...
- **Profile Management**: View statistics, change avatar, manage account
...
### Frontend
- **HTML5 Canvas**: Game board rendering and line drawing
- **JavaScript (ES6+)**: Modern JavaScript with modular architecture
- **CSS3**: Responsive design with modern styling
- **Web Audio API**: Dice roll sound effects

### Backend
- **Node.js**: Server runtime environment
- **Express.js**: Web application framework
- **Socket.IO**: Real-time bidirectional communication
- **MongoDB**: Database for user data and game statistics
...
- **Render**: Static site and backend hosting
- **Environment Variables**: Secure configuration management

## 📋 Changelog

### Version 3.0.0 (Current) - Major Release
- **🎡 Lucky Wheel Layout Fix**: Spin and Close buttons positioned left and right as requested
- **🌐 Online Mode Optimization**: Lucky Wheel disabled for Online Multiplayer for balanced gameplay
- **🔄 Turn Synchronization**: Improved turn management and synchronization in online multiplayer
- **🔐 User Authentication**: Complete user management system with registration, login, and profiles
- **📊 Game Statistics**: Track games played, wins, and win rate for registered users
- **🎨 UI/UX Improvements**: Enhanced visual design and user experience
- **📱 Mobile Optimization**: Improved touch controls and mobile compatibility
- **🚀 Performance Enhancements**: Optimized game performance and responsiveness
- **📚 Documentation Update**: Comprehensive rules and information updated with latest features
- **🗂️ Project Cleanup**: Removed unwanted files and optimized project structure
- **🎲 Enhanced Dice System**: 
  - Dynamic gameplay with random dice values 1-6
  - Mode-specific behavior for dice roll 6
  - Lucky Wheel in Single Player & Two Players only
- **🎯 Lucky Wheel System**: 
...
- **🤖 Improved AI Behavior**:
  - Advanced decision-making with strategic planning
  - Proper handling of all Lucky Wheel outcomes
  - Enhanced turn management and timing
- **🐛 Bug Fixes**: 
  - Fixed Lucky Wheel button layout
  - Fixed online multiplayer turn management
  - Fixed user authentication and session handling
  - Fixed all game mode functionality
  - Fixed Git repository issues and added proper .gitignore
